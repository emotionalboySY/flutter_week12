    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (builder) => const FilterMessagePage()));
            },
...
class ChatElement extends StatelessWidget {
  const ChatElement({Key? key, this.isMe, this.userName, this.text}) : super(key: key);
  final bool? isMe;
